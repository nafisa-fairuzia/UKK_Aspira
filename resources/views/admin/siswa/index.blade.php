                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            @if($item->profile_pic)
                                            <img src="{{ asset('storage/' . $item->profile_pic) }}"
                                                class="rounded-circle me-3 border shadow-sm"
                                                style="width: 35px; height: 35px; object-fit: cover; flex-shrink: 0;"
                                                onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name={{ urlencode($item->nama) }}&color=7F9CF5&background=EBF4FF';">
                                            @else
                                            <div class="avatar-sm me-3 bg-primary-subtle rounded-circle d-flex align-items-center justify-content-center" style="width: 35px; height: 35px; flex-shrink: 0;">
                                                <span class="text-primary fw-bold small">{{ substr($item->nama, 0, 1) }}</span>
                                            </div>
                                            @endif
                                            <div>
                                                <div class="text-dark mb-0">{{ $item->nama }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="text-muted fw-medium">{{ $item->kelas->nama_kelas }}</span>
                                    </td>
    ...
    <div class="modal fade" id="modalTambahSiswa" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow" style="border-radius: 20px;">
                ...
                <form action="{{ route('admin.siswa.store') }}" method="POST" autocomplete="off">
                    @csrf
