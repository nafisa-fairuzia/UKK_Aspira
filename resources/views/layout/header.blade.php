    ...
    <div class="ms-auto d-flex align-items-center gap-3">
        ...
        <div class="dropdown">
            <button class="btn d-flex align-items-center border-0 p-0" data-bs-toggle="dropdown">
                <img src="{{ $displayPic }}" class="profile-img rounded-circle shadow-sm" width="35" height="35" style="object-fit: cover;" data-default="{{ $defaultAvatar }}">
                <h6 class="ms-2 mb-0 text-dark fw-semibold d-none d-md-block">{{ $avatarName }}</h6>
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 p-2" style="min-width: 200px; border-radius: 12px;">
                <li class="px-2 py-1">
                    <div class="d-flex align-items-center">
                        <img src="{{ $displayPic }}" class="profile-img rounded-circle me-2" width="40" height="40" style="object-fit: cover;">
                        <div>
                            <div class="fw-bold small">{{ $avatarName }}</div>
                            <small class="text-muted" style="font-size: 11px;">{{ $role == 'admin' ? 'Administrator' : 'Siswa' }}</small>
                        </div>
                    </div>
                </li>
                <li>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow" style="border-radius: 16px;">
            ...
            <div class="modal-body p-4 text-center">
                <img id="modalProfilePic" src="{{ $displayPic }}" class="rounded-circle shadow-sm mb-3" width="100" height="100" style="object-fit: cover;">
                <form id="profilePicForm" class="text-start">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" id="deletePicBtn" class="btn btn-outline-danger flex-fill" aria-label="Hapus foto" @if(!$profilePic) disabled @endif>Hapus</button>
                    </div>
                </form>
            </div>
        </div>
