                ...
                <div class="col-lg-4">
                    <div class="sticky-wrapper">
                        <div class="card border-0 shadow-sm mb-4 overflow-hidden">
                            ...
                            <div class="card-body p-4">
                                @if($aspirasiData && $aspirasiData->feedback)
                                <div class="p-3 bg-light rounded-3 border-start border-3 border-primary">
                                    <p class="mb-3 text-dark small lh-base">{{ $aspirasiData->feedback }}</p>
                        ...
                        <a href="{{ route('siswa.pengaduan.lainnya') }}" class="btn btn-outline-primary mt-4 w-100 fw-bold rounded-3">
