...
<div class="siswa-show">
                        ...
                        <div class="card-body p-4">
                            <div class="row position-relative">
                                ...
                                <div class="col text-center">
                                    ...
                                    <span class="small fw-bold {{ $reached ? 'text-dark' : 'text-muted' }}">{{ $step['title'] }}</span>
                                </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="attachment-box mt-4">
                                ...
                                <div class="position-relative d-inline-block w-100">
                                    <img src="{{ asset('storage/' . $aspirasi->gambar) }}" class="img-fluid rounded border shadow-sm"
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-10">
                                        {{ $aspirasi->kategori->ket_kategori ?? 'Umum' }}
                                    </span>
                                </div>

                                <div class="d-flex justify-content-between mb-3">
                                    <span class="text-muted small">Tgl Kirim</span>
                                    <span class="small fw-bold text-dark">{{ $aspirasi->formatted_created_at }}</span>
                                </div>
    ...
    <script src="{{ asset('assets/js/siswa/pengaduan-show.js') }}?v={{ time() }}"></script>
