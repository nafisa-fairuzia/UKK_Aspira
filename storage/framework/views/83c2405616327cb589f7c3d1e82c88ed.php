...
<head>
    ...
    <title>Login - Aspira Digital</title>
        ...
        <div class="row g-0">
            <div class="col-lg-7 d-flex visual-section italic">
                ...
                <div class="illustration-wrapper text-center" data-aos="fade-up">
                    <img src="<?php echo e(asset('assets/img/aspira2.png')); ?>" alt="Digital Illustration">
                </div>
            </div>
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" autocomplete="off">
                        ...
                        <div class="d-grid mt-5">
                            ...
                            <div class="text-center mt-3">
                                <a href="<?php echo e(url('/')); ?>" class="text-decoration-none text-muted small hover-sky">
...
</html><?php /**PATH C:\laragon\www\UKK_Aspira\resources\views/auth/login.blade.php ENDPATH**/ ?>