    ...
    <main id="main-content">
        <div class="card welcome-card mb-4 mt-4 border-0 shadow-lg position-relative overflow-hidden rounded-4">
            <div class="card-body p-4 p-md-5">
                ...
                <img src="<?php echo e(asset('assets/img/aspira4.png')); ?>" class="welcome-img" alt="Illustration">
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-6 col-lg-3">
                <a href="<?php echo e($cardLink); ?>" class="text-decoration-none">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 h-100 card-hover">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                ...
                                ?>
                                <span class="badge <?php echo e($badgeClass); ?> border-0 px-3 py-2 rounded-pill small fw-bold">
                            ...
                            <div class="mb-4">
                                ...
                                <p class="mb-0 text-muted x-small">
                                    <i class="ti ti-clock me-1"></i> <?php echo e($item->formatted_created_at); ?>
...
<script src="<?php echo e(asset('assets/js/admin/dashboard-chart.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopPush(); ?>
