...
<link rel="stylesheet" href="<?php echo e(asset('assets/css/admin/dashboard.css')); ?>?v=<?php echo e(time()); ?>">
<?php $__env->stopPush(); ?>
    ...
    <main id="main-content">
        <div class="card welcome-card mb-4 border-0 shadow-lg position-relative overflow-hidden rounded-4">
            <div class="card-body p-4 p-md-5">
                <div class="position-relative" style="z-index: 2; max-width: 600px;">
                    ...
                    <h2 class="fw-bold text-white mb-2">Hi, <?php echo e(Session::get('nama') ?? 'Admin'); ?>! ✨</h2>
                    <p class="text-white opacity-75 mb-4">
                        Pantau dan kelola seluruh kondisi sarana prasarana sekolah untuk memastikan kenyamanan belajar tetap terjaga.
                    </p>
                    <a href="<?php echo e(route('admin.pengaduan.index')); ?>" class="btn btn-light rounded-pill px-4 fw-bold shadow-sm">
                        <i class="ti ti-message-circle-search me-1"></i> Cek Laporan
                    </a>
                </div>

                <div class="decoration-circle-1"></div>
                <div class="decoration-circle-2"></div>
                <img src="<?php echo e(asset('assets/img/aspira4.png')); ?>" class="welcome-img d-none d-md-block" alt="Illustration">
            </div>
        </div>
            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    ...
                    <div class="card-body p-4">
                        ...
                        $chart_data[] = \App\Models\InputAspirasi::whereDate('created_at', $date)->count();
                        }
                        ?>
            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-6">
                                <a href="<?php echo e(route('admin.pengaduan.index')); ?>" class="text-decoration-none">
                            ...
                            <div class="col-6">
                                <a href="<?php echo e(route('admin.siswa.index')); ?>" class="text-decoration-none">
                                    <div class="action-card text-center p-3 rounded-3 border">
                            ...
                            <div class="col-6">
                                <a href="<?php echo e(route('admin.kategori.index')); ?>" class="text-decoration-none">
                                    <div class="action-card text-center p-3 rounded-3 border">
                            ...
                            <div class="col-6">
                                <a href="<?php echo e(route('admin.admins.index')); ?>" class="text-decoration-none">
                                    <div class="action-card text-center p-3 rounded-3 border">
        ...
        <div class="mt-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('admin.pengaduan.index')); ?>" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 h-100 card-hover">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <span class="badge <?php echo e($item->status == 'Selesai' ? 'bg-success-subtle text-success' : ($item->status == 'Proses' ? 'bg-primary-subtle text-primary' : 'bg-warning-subtle text-warning')); ?> border-0 px-3 py-2 rounded-pill small fw-bold">
                                    <?php echo e(strtoupper($item->status ?? 'MENUNGGU')); ?>

                                </span>
                                <small class="text-muted fw-medium">ASP-<?php echo e(sprintf('%05d', $item->id_pelaporan)); ?></small>
                            </div>

                            <div class="d-flex align-items-center mb-4">
                                <?php if($item->siswa && $item->siswa->profile_pic): ?>
                                <img src="<?php echo e(asset('storage/' . $item->siswa->profile_pic)); ?>"
                                    class="rounded-3 me-3 border shadow-sm"
                                    style="width: 45px; height: 45px; object-fit: cover; flex-shrink: 0;"
                                    onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($item->siswa->nama)); ?>&color=7F9CF5&background=EBF4FF';">
                                <?php else: ?>
                                <div class="avatar-box bg-dark text-white rounded-3 d-flex align-items-center justify-content-center fw-bold me-3" style="width: 45px; height: 45px;">
                                    <?php echo e(strtoupper(substr($item->siswa->nama ?? 'S', 0, 1))); ?>

                                </div>
                                <?php endif; ?>
                                <div>
                                    <h6 class="mb-0 fw-bold"><?php echo e($item->siswa->nama ?? 'N/A'); ?></h6>
                                    <small class="text-muted">NIS: <?php echo e($item->nis); ?></small>
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="mb-0 text-muted x-small">
                                    <i class="ti ti-clock me-1"></i> <?php echo e($item->created_at->format('d M Y, H:i')); ?>

                                </p>
                            </div>

                            <a href="<?php echo e(route('admin.pengaduan.show', $item->id_pelaporan)); ?>" class="btn btn-outline-primary btn-sm w-100 rounded-3 py-2 fw-bold">
                                Kelola Laporan <i class="ti ti-arrow-right ms-1"></i>
                            </a>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Buat gradien warna biru transparan
            ...
            options: {
                ...
                scales: {
                    y: {
                        beginAtZero: true,
                        ticks: {
                            stepSize: 5, // Kelipatan 5 (0, 5, 10, 15)
                            color: '#94a3b8',
                            font: {
                                size: 11
                            }
                        ...
                        grid: {
                            ...
                            drawBorder: false,
                            borderDash: [5, 5] // Garis putus-putus horizontal
                        }
                    },
                    x: {
                        grid: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\UKK_Aspira\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>