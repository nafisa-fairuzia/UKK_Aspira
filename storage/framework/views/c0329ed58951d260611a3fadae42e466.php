            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                    <div class="d-inline-flex gap-2">
                        ...
                        <?php if(!$feedback && $currentStatus == 'Menunggu'): ?>
                        <a href="<?php echo e(route('siswa.pengaduan.editForm', $aspirasi->id_pelaporan)); ?>" class="btn btn-primary shadow-sm fw-bold px-3">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="attachment-box mt-4">
                                ...
                                <div class="position-relative d-inline-block w-100">
                                    <img src="<?php echo e(asset('storage/' . $aspirasi->gambar)); ?>" class="img-fluid rounded border shadow-sm" style="max-height: 500px; width: 100%; object-fit: contain; background: #eee;">
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div id="respon" class="card border-0 shadow-sm mb-4 overflow-hidden">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-3 bg-light rounded-3 border-start border-3 border-primary">
                                    <p class="mb-3 text-dark small lh-base"><?php echo e($feedback); ?></p>
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-10"><?php echo e($aspirasi->kategori->ket_kategori ?? 'Umum'); ?></span>
                                </div>

                                <div class="d-flex justify-content-between mb-3">
                                    <span class="text-muted small">Tgl Kirim</span>
                                    <span class="small fw-bold text-dark"><?php echo e($aspirasi->created_at->format('d M Y, H:i')); ?></span>
                                </div>
            ...
            <div class="modal-content border-0 shadow-lg rounded-4">
                <div class="modal-body p-4 text-center">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        ...
                        <form method="POST" action="<?php echo e(route('siswa.pengaduan.cancel', $aspirasi->id_pelaporan)); ?>" class="w-100">
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\UKK_Aspira\resources\views/siswa/pengaduan/show.blade.php ENDPATH**/ ?>